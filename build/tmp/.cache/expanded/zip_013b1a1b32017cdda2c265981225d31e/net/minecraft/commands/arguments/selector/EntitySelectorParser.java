...
public class EntitySelectorParser {
   ...
   public EntitySelector getSelector() {
      ...
      if (this.deltaX == null && this.deltaY == null && this.deltaZ == null) {
         if (this.distance.m_55326_() != null) {
            double d0 = this.distance.m_55326_();
   ...
   private Predicate<Entity> createRotationPredicate(WrappedMinMaxBounds pAngleBounds, ToDoubleFunction<Entity> pAngleFunction) {
      double d0 = (double)Mth.wrapDegrees(pAngleBounds.m_75358_() == null ? 0.0F : pAngleBounds.m_75358_());
      double d1 = (double)Mth.wrapDegrees(pAngleBounds.m_75366_() == null ? 359.0F : pAngleBounds.m_75366_());
      return (p_175137_) -> {
