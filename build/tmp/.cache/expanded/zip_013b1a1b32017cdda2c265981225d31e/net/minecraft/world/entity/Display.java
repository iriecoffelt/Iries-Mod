...
public abstract class Display extends Entity {
   ...
   private static final EntityDataAccessor<Integer> f_276329_ = SynchedEntityData.defineId(Display.class, EntityDataSerializers.INT);
   private static final EntityDataAccessor<Integer> f_268449_ = SynchedEntityData.defineId(Display.class, EntityDataSerializers.INT);
   ...
   private final Quaternionf f_268732_ = new Quaternionf();
   ...
   public void onSyncedDataUpdated(EntityDataAccessor<?> pKey) {
      ...
      if (f_276329_.equals(pKey)) {
         this.updateStartTick = true;
      }

      if (f_268449_.equals(pKey)) {
   ...
   public void tick() {
      ...
      if (this.level().isClientSide) {
         ...
         if (this.updateInterpolationDuration) {
            ...
            this.interpolationDuration = this.m_269272_();
         }
   ...
   protected void defineSynchedData() {
      this.entityData.define(f_276329_, 0);
      this.entityData.define(f_268449_, 0);
   ...
   protected void addAdditionalSaveData(CompoundTag pCompound) {
      ...
      pCompound.putInt("interpolation_duration", this.m_269272_());
   ...
   private void m_269317_(int p_270803_) {
      this.entityData.set(f_268449_, p_270803_);
   }

   private int m_269272_() {
      return this.entityData.get(f_268449_);
   }

   private void m_276345_(int p_276366_) {
      this.entityData.set(f_276329_, p_276366_, true);
   }

   private int m_276347_() {
      return this.entityData.get(f_276329_);
   }
   ...
   private void m_269417_() {
      this.f_268732_.rotationYXZ(-0.017453292F * this.getYRot(), ((float)Math.PI / 180F) * this.getXRot(), 0.0F);
   }
