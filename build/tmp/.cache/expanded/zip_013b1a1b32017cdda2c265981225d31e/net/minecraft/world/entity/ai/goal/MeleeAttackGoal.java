...
public class MeleeAttackGoal extends Goal {
         ...
         if (livingentity == null) {
           ...
           if (canPenalize) {
            ...
            if (this.path != null) {
               ...
               return this.m_6639_(livingentity) >= this.mob.distanceToSqr(livingentity.getX(), livingentity.getY(), livingentity.getZ());
            }
         }
      }
   }
   ...
   protected void checkAndPerformAttack(LivingEntity pTarget, double p_25558_) {
      double d0 = this.m_6639_(pTarget);
