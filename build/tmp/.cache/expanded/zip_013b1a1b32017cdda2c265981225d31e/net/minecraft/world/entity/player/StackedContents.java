...
public class StackedContents {
   ...
   public int getBiggestCraftableStack(Recipe<?> p_36494_, @Nullable IntList pStackingIndexList) {
      return this.getBiggestCraftableStack(p_36494_, Integer.MAX_VALUE, pStackingIndexList);
   }

   public int getBiggestCraftableStack(Recipe<?> p_36472_, int pAmount, @Nullable IntList pStackingIndexList) {
      return (new StackedContents.RecipePicker(p_36472_)).tryPickAll(pAmount, pStackingIndexList);
   }
