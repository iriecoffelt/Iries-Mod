   ...
   protected static void slotChangedCraftingGrid(AbstractContainerMenu pMenu, Level pLevel, Player pPlayer, CraftingContainer pContainer, ResultContainer pResult) {
      if (!pLevel.isClientSide) {
         ...
         if (optional.isPresent()) {
            ...
            if (pResult.m_40135_(pLevel, serverplayer, craftingrecipe)) {
         ...
         serverplayer.connection.m_9829_(new ClientboundContainerSetSlotPacket(pMenu.containerId, pMenu.incrementStateId(), 0, itemstack));
      }
   }
