...
public class RandomSequence {
   ...
   private static XoroshiroRandomSource createSequence(long pSeed, ResourceLocation p_289545_) {
      return new XoroshiroRandomSource(RandomSupport.upgradeSeedTo128bitUnmixed(pSeed).xor(seedForKey(p_289545_)).mixed());
   }
