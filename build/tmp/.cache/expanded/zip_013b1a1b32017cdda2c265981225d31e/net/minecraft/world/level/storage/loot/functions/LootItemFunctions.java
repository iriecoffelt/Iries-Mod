...
public class LootItemFunctions {
   ...
   private static LootItemFunctionType register(String pId, Serializer<? extends LootItemFunction> p_80764_) {
      return Registry.register(BuiltInRegistries.LOOT_FUNCTION_TYPE, new ResourceLocation(pId), new LootItemFunctionType(p_80764_));
   }

   public static Object m_80758_() {
      return GsonAdapterFactory.m_78801_(BuiltInRegistries.LOOT_FUNCTION_TYPE, "function", "function", LootItemFunction::getType).m_78822_();
   }
