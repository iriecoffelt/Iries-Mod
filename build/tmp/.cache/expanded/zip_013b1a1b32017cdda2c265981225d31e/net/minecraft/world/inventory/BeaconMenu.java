...
public class BeaconMenu extends AbstractContainerMenu {
   ...
   public MobEffect getPrimaryEffect() {
      return MobEffect.m_19453_(this.beaconData.get(1));
   }

   @Nullable
   public MobEffect getSecondaryEffect() {
      return MobEffect.m_19453_(this.beaconData.get(2));
   }

   public void updateEffects(Optional<MobEffect> pPrimaryEffect, Optional<MobEffect> pSecondaryEffect) {
      if (this.paymentSlot.hasItem()) {
         this.beaconData.set(1, pPrimaryEffect.map(MobEffect::m_19459_).orElse(-1));
         this.beaconData.set(2, pSecondaryEffect.map(MobEffect::m_19459_).orElse(-1));
