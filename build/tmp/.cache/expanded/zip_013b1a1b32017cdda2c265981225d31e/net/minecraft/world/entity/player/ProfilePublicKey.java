...
public record ProfilePublicKey(ProfilePublicKey.Data data) {
   ...
   public static ProfilePublicKey createValidated(SignatureValidator pSignatureValidator, UUID pProfileId, ProfilePublicKey.Data pData, Duration p_243387_) throws ProfilePublicKey.ValidationException {
      if (pData.hasExpired(p_243387_)) {
         throw new ProfilePublicKey.ValidationException(EXPIRED_PROFILE_PUBLIC_KEY);
      } else if (!pData.validateSignature(pSignatureValidator, pProfileId)) {
