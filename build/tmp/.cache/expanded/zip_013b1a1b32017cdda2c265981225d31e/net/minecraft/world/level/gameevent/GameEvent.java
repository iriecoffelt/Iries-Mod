...
public class GameEvent {
   ...
   public static final GameEvent f_223709_ = register("entity_roar");
   public static final GameEvent f_223710_ = register("entity_shake");
   ...
   public GameEvent(String p_157819_, int pNotificationRadius) {
   ...
   public String toString() {
      return "Game Event{ " + this.f_157789_ + " , " + this.notificationRadius + "}";
   }
