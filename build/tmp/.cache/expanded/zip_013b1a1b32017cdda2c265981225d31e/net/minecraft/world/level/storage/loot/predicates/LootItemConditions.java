...
public class LootItemConditions {
   ...
   private static LootItemConditionType register(String pName, Serializer<? extends LootItemCondition> p_81833_) {
      return Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, new ResourceLocation(pName), new LootItemConditionType(p_81833_));
   }

   public static Object m_81828_() {
      return GsonAdapterFactory.m_78801_(BuiltInRegistries.LOOT_CONDITION_TYPE, "condition", "condition", LootItemCondition::getType).m_78822_();
   }
