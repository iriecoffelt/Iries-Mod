...
public class SmithingTrimRecipe implements SmithingRecipe {
   ...
   public SmithingTrimRecipe(ResourceLocation p_267235_, Ingredient pTemplate, Ingredient pBase, Ingredient pAddition) {
      this.f_265885_ = p_267235_;
   ...
   public static class Serializer implements RecipeSerializer<SmithingTrimRecipe> {
      public SmithingTrimRecipe m_6729_(ResourceLocation p_267037_, JsonObject p_267004_) {
         Ingredient ingredient = Ingredient.m_43917_(GsonHelper.getNonNull(p_267004_, "template"));
         Ingredient ingredient1 = Ingredient.m_43917_(GsonHelper.getNonNull(p_267004_, "base"));
         Ingredient ingredient2 = Ingredient.m_43917_(GsonHelper.getNonNull(p_267004_, "addition"));
