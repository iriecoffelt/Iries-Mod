...
public class SignText {
   ...
   public static final Codec<SignText> DIRECT_CODEC = RecordCodecBuilder.create((p_277675_) -> {
      ...
      }), LINES_CODEC.optionalFieldOf("filtered_messages").forGetter(SignText::m_276946_), DyeColor.CODEC.fieldOf("color").orElse(DyeColor.BLACK).forGetter((p_277343_) -> {
   ...
   private static SignText load(Component[] p_277661_, Optional<Component[]> p_277768_, DyeColor p_277345_, boolean p_278008_) {
      ...
      m_276973_(p_277661_, acomponent);
      return new SignText(p_277661_, acomponent, p_277345_, p_278008_);
   }

   private static void m_276973_(Component[] p_277696_, Component[] p_277436_) {
      for(int i = 0; i < 4; ++i) {
   ...
   private Optional<Component[]> m_276946_() {
