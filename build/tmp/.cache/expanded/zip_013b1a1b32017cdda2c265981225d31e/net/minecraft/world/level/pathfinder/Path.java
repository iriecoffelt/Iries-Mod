...
public class Path {
   ...
   void setDebug(Node[] pOpenSet, Node[] pClosedSet, Set<Target> pTargetNodes) {
      this.f_77363_ = pOpenSet;
      this.f_77364_ = pClosedSet;
      this.f_77365_ = pTargetNodes;
   }
   ...
   public void writeToStream(FriendlyByteBuf pBuffer) {
      if (this.f_77365_ != null && !this.f_77365_.isEmpty()) {
         ...
         pBuffer.writeInt(this.f_77365_.size());
         ...
         pBuffer.writeInt(this.f_77363_.length);

         for(Node node1 : this.f_77363_) {
            node1.writeToStream(pBuffer);
         }

         pBuffer.writeInt(this.f_77364_.length);
