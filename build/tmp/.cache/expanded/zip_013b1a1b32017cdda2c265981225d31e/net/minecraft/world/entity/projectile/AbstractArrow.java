...
public abstract class AbstractArrow extends Projectile {
   ...
   public void lerpTo(double pX, double pY, double pZ, float pYRot, float pXRot, int pSteps, boolean p_36734_) {
      this.setPos(pX, pY, pZ);
      ...
      if (entity.hurt(damagesource, (float)i)) {
         ...
         if (entity instanceof LivingEntity) {
            ...
            if (entity1 != null && livingentity != entity1 && livingentity instanceof Player && entity1 instanceof ServerPlayer && !this.isSilent()) {
               ((ServerPlayer)entity1).connection.m_9829_(new ClientboundGameEventPacket(ClientboundGameEventPacket.ARROW_HIT_PLAYER, 0.0F));
            }
