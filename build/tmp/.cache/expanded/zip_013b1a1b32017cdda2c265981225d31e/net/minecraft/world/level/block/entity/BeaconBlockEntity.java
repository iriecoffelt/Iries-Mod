...
public class BeaconBlockEntity extends BlockEntity implements MenuProvider, Nameable {
      ...
      public int get(int p_58711_) {
         ...
         switch (p_58711_) {
            case 0:
               ...
               break;
            case 1:
               i = MobEffect.m_216882_(BeaconBlockEntity.this.primaryPower);
               break;
            case 2:
               i = MobEffect.m_216882_(BeaconBlockEntity.this.secondaryPower);
               break;
            default:
               i = 0;
         }
      ...
      public void set(int p_58713_, int p_58714_) {
         switch (p_58713_) {
            ...
            case 1:
               ...
               BeaconBlockEntity.this.primaryPower = BeaconBlockEntity.m_58686_(p_58714_);
               break;
            case 2:
               BeaconBlockEntity.this.secondaryPower = BeaconBlockEntity.m_58686_(p_58714_);
         }
   ...
   public void load(CompoundTag pTag) {
      super.load(pTag);
      this.primaryPower = m_58686_(pTag.getInt("Primary"));
      this.secondaryPower = m_58686_(pTag.getInt("Secondary"));
   ...
   protected void saveAdditional(CompoundTag pTag) {
      ...
      pTag.putInt("Primary", MobEffect.m_216882_(this.primaryPower));
      pTag.putInt("Secondary", MobEffect.m_216882_(this.secondaryPower));
