...
public class ServerPlaceRecipe<C extends Container> implements PlaceRecipe<Integer> {
   ...
   public void recipeClicked(ServerPlayer pPlayer, @Nullable Recipe<C> p_135436_, boolean pPlaceAll) {
      if (p_135436_ != null && pPlayer.getRecipeBook().contains(p_135436_)) {
         ...
         if (this.testClearGrid() || pPlayer.isCreative()) {
            ...
            if (this.stackedContents.canCraft(p_135436_, (IntList)null)) {
               this.handleRecipeClicked(p_135436_, pPlaceAll);
            } else {
               this.clearGrid();
               pPlayer.connection.m_9829_(new ClientboundPlaceGhostRecipePacket(pPlayer.containerMenu.containerId, p_135436_));
            }
   ...
   protected void handleRecipeClicked(Recipe<C> p_135441_, boolean pPlaceAll) {
