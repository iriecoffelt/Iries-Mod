...
public class CompoundTag implements Tag {
   ...
   static Tag readNamedTagData(TagType<?> pType, String pName, DataInput pInput, int p_128417_, NbtAccounter pAccounter) {
      try {
         return pType.load(pInput, p_128417_, pAccounter);
