...
public class ServerRecipeBook extends RecipeBook {
   ...
   private void sendRecipes(ClientboundRecipePacket.State pState, ServerPlayer pPlayer, List<ResourceLocation> pRecipes) {
      pPlayer.connection.m_9829_(new ClientboundRecipePacket(pState, pRecipes, Collections.emptyList(), this.getBookSettings()));
   }
   ...
   public void sendInitialRecipeBook(ServerPlayer pPlayer) {
      pPlayer.connection.m_9829_(new ClientboundRecipePacket(ClientboundRecipePacket.State.INIT, this.known, this.highlight, this.getBookSettings()));
   }
}