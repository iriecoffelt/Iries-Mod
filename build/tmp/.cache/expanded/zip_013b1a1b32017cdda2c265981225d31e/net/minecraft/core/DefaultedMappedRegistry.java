...
public class DefaultedMappedRegistry<T> extends MappedRegistry<T> implements DefaultedRegistry<T> {
   ...
   public Holder.Reference<T> m_203704_(int pId, ResourceKey<T> pKey, T pValue, Lifecycle pLifecycle) {
      Holder.Reference<T> reference = super.m_203704_(pId, pKey, pValue, pLifecycle);
