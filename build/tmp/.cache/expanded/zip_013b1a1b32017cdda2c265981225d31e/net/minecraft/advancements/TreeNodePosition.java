...
public class TreeNodePosition {
   ...
   public TreeNodePosition(Advancement p_16567_, @Nullable TreeNodePosition pParent, @Nullable TreeNodePosition pPreviousSibling, int pChildIndex, int pX) {
   ...
   @Nullable
   private TreeNodePosition addChild(Advancement p_16590_, @Nullable TreeNodePosition pPreviousSibling) {
      if (p_16590_.m_138320_() != null) {
         pPreviousSibling = new TreeNodePosition(p_16590_, this, pPreviousSibling, this.children.size() + 1, this.x + 1);
         this.children.add(pPreviousSibling);
      } else {
         for(Advancement advancement : p_16590_.m_138322_()) {
            pPreviousSibling = this.addChild(advancement, pPreviousSibling);
         }
      }
   ...
   private void finalizePosition() {
      if (this.f_16554_.m_138320_() != null) {
         this.f_16554_.m_138320_().setLocation((float)this.x, this.y);
      }
