...
public class EntityEquipmentPredicate {
   ...
   public static final EntityEquipmentPredicate CAPTAIN = new EntityEquipmentPredicate(ItemPredicate.Builder.item().of(Items.WHITE_BANNER).hasNbt(Raid.getLeaderBannerInstance().getTag()).build(), ItemPredicate.f_45028_, ItemPredicate.f_45028_, ItemPredicate.f_45028_, ItemPredicate.f_45028_, ItemPredicate.f_45028_);
   ...
   public static class Builder {
      private ItemPredicate head = ItemPredicate.f_45028_;
      private ItemPredicate chest = ItemPredicate.f_45028_;
      private ItemPredicate legs = ItemPredicate.f_45028_;
      private ItemPredicate feet = ItemPredicate.f_45028_;
      private ItemPredicate mainhand = ItemPredicate.f_45028_;
      private ItemPredicate offhand = ItemPredicate.f_45028_;
