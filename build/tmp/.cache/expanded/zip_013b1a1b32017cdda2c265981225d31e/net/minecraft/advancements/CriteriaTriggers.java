...
public class CriteriaTriggers {
   ...
   public static <T extends CriterionTrigger<?>> T register(T pTrigger) {
      if (CRITERIA.containsKey(pTrigger.m_7295_())) {
         throw new IllegalArgumentException("Duplicate criterion id " + pTrigger.m_7295_());
      } else {
         CRITERIA.put(pTrigger.m_7295_(), pTrigger);
         return pTrigger;
      }
   }
