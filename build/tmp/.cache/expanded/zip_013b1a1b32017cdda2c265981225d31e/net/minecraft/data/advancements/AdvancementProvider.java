   ...
   public CompletableFuture<?> run(CachedOutput pOutput) {
      return this.registries.thenCompose((p_255484_) -> {
         ...
         Consumer<Advancement> consumer = (p_253397_) -> {
            if (!set.add(p_253397_.m_138327_())) {
               throw new IllegalStateException("Duplicate advancement " + p_253397_.m_138327_());
            } else {
               Path path = this.pathProvider.json(p_253397_.m_138327_());
               list.add(DataProvider.saveStable(pOutput, p_253397_.m_138313_().m_138400_(), path));
            }
         };
