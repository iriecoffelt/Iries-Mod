...
public class VanillaRecipeProvider extends RecipeProvider {
   ...
   public CompletableFuture<?> run(CachedOutput p_254376_) {
      return CompletableFuture.allOf(super.run(p_254376_), this.buildAdvancement(p_254376_, RecipeBuilder.ROOT_RECIPE_ADVANCEMENT, Advancement.Builder.recipeAdvancement().m_138386_("impossible", new ImpossibleTrigger.TriggerInstance())));
   }
