...
public class ServerScoreboard extends Scoreboard {
   ...
   public void setDisplayObjective(int p_136199_, @Nullable Objective pObjective) {
      Objective objective = this.getDisplayObjective(p_136199_);
      super.setDisplayObjective(p_136199_, pObjective);
      if (objective != pObjective && objective != null) {
         if (this.getObjectiveDisplaySlotCount(objective) > 0) {
            this.server.getPlayerList().broadcastAll(new ClientboundSetDisplayObjectivePacket(p_136199_, pObjective));
         } else {
