...
public class ServerPacksSource extends BuiltInPackSource {
   ...
   public static PackRepository createPackRepository(Path pFolder) {
      final PackRepository packRepository = new PackRepository(new ServerPacksSource(), new FolderRepositorySource(pFolder, PackType.SERVER_DATA, PackSource.WORLD));
