...
public class ServerHandshakePacketListenerImpl implements ServerHandshakePacketListener {
   ...
   public void handleIntention(ClientIntentionPacket pPacket) {
      ...
      switch (pPacket.m_134735_()) {
         case LOGIN:
            this.connection.m_129498_(ConnectionProtocol.LOGIN);
            if (pPacket.m_134738_() != SharedConstants.getCurrentVersion().getProtocolVersion()) {
               Component component;
               if (pPacket.m_134738_() < 754) {
         ...
         case STATUS:
            ...
            break;
         default:
            throw new UnsupportedOperationException("Invalid intention " + pPacket.m_134735_());
      }
