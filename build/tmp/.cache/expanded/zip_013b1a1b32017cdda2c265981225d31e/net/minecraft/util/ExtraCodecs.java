...
public class ExtraCodecs {
   ...
   public static final Codec<Instant> INSTANT_ISO8601 = temporalCodec(DateTimeFormatter.ISO_INSTANT);
   ...
   public static final Codec<GameProfile> GAME_PROFILE = RecordCodecBuilder.create((p_253497_) -> {
      ...
      }).optionalFieldOf("name", Optional.empty())).flatXmap(ExtraCodecs::m_252898_, ExtraCodecs::m_252819_).forGetter(Function.identity()), PROPERTY_MAP.optionalFieldOf("properties", new PropertyMap()).forGetter(GameProfile::getProperties)).apply(p_253497_, (p_253518_, p_253519_) -> {
   ...
   public static Codec<Instant> temporalCodec(DateTimeFormatter pDateTimeFormatter) {
   ...
   private static DataResult<GameProfile> m_252898_(Pair<Optional<UUID>, Optional<String>> p_253764_) {
      try {
   ...
   private static DataResult<Pair<Optional<UUID>, Optional<String>>> m_252819_(GameProfile p_254220_) {
