...
public class CommonLinks {
   ...
   public static String extendRealms(String pSubscriptionId, String p_276293_, boolean pIsTrial) {
      return extendRealms(pSubscriptionId, p_276293_) + "&ref=" + (pIsTrial ? "expiredTrial" : "expiredRealm");
   }

   public static String extendRealms(String pSubscriptionId, String p_276285_) {
      return "https://aka.ms/ExtendJavaRealms?subscriptionId=" + pSubscriptionId + "&profileId=" + p_276285_;
   }
}