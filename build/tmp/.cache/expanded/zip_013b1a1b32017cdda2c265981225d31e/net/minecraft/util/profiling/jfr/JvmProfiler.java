...
public interface JvmProfiler {
   ...
   void onPacketReceived(int pPacketId, int pBytes, SocketAddress pRemoteAddress, int p_185346_);

   void onPacketSent(int pPacketId, int pBytes, SocketAddress pRemoteAddress, int p_185354_);
