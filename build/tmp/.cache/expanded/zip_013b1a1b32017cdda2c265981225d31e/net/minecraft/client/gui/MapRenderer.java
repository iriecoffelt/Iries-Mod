      ...
      void draw(PoseStack pPoseStack, MultiBufferSource pBufferSource, boolean pActive, int pPackedLight) {
         ...
         for(MapDecoration mapdecoration : this.data.getDecorations()) {
            if (!pActive || mapdecoration.renderOnFrame()) {
               ...
               pPoseStack.pushPose();
               pPoseStack.translate(0.0F + (float)mapdecoration.m_77804_() / 2.0F + 64.0F, 0.0F + (float)mapdecoration.m_77805_() / 2.0F + 64.0F, -0.02F);
               pPoseStack.mulPose(Axis.ZP.rotationDegrees((float)(mapdecoration.m_77806_() * 360) / 16.0F));
               ...
               if (mapdecoration.m_77810_() != null) {
                  ...
                  pPoseStack.pushPose();
                  pPoseStack.translate(0.0F + (float)mapdecoration.m_77804_() / 2.0F + 64.0F - f6 * f7 / 2.0F, 0.0F + (float)mapdecoration.m_77805_() / 2.0F + 64.0F + 4.0F, -0.025F);
