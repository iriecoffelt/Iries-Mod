...
public class OverlayRecipeComponent implements Renderable, GuiEventListener {
   ...
   public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
      if (this.isVisible) {
         ...
         int l = 4;
         pGuiGraphics.m_280260_(f_100172_, this.x, this.y, j * 25 + 8, k * 25 + 8, 4, 32, 32, 82, 208);
   ...
   class OverlayRecipeButton extends AbstractWidget implements PlaceRecipe<Ingredient> {
      ...
      public OverlayRecipeButton(int pX, int pY, Recipe<?> p_100234_, boolean pIsCraftable) {
      ...
      public void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
         ...
         pGuiGraphics.blit(OverlayRecipeComponent.f_100172_, this.getX(), this.getY(), i, j, this.width, this.height);
         pGuiGraphics.pose().pushPose();
