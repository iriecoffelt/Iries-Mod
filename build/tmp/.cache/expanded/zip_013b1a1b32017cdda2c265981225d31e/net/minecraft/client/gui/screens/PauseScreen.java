...
public class PauseScreen extends Screen {
   ...
   private static final Component f_262246_ = Component.translatable("menu.disconnect");
   ...
   private void createPauseMenu() {
      ...
      Component component = this.minecraft.isLocalServer() ? RETURN_TO_MENU : f_262246_;
   ...
   private void onDisconnect() {
      ...
      boolean flag1 = this.minecraft.m_91294_();
   ...
   public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
      ...
      if (this.showPauseMenu && this.minecraft != null && this.minecraft.getReportingContext().hasDraftReport() && this.disconnectButton != null) {
         pGuiGraphics.blit(AbstractWidget.f_93617_, this.disconnectButton.getX() + this.disconnectButton.getWidth() - 17, this.disconnectButton.getY() + 3, 182, 24, 15, 15);
      }
