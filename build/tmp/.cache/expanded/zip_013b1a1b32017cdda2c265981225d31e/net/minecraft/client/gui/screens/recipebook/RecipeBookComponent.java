...
public class RecipeBookComponent implements PlaceRecipe<Ingredient>, Renderable, GuiEventListener, NarratableEntry, RecipeShownListener {
   ...
   private void updateCollections(boolean pResetPageNumber) {
      ...
      if (!s.isEmpty()) {
         ObjectSet<RecipeCollection> objectset = new ObjectLinkedOpenHashSet<>(this.minecraft.getSearchTree(SearchRegistry.f_119943_).search(s.toLowerCase(Locale.ROOT)));
   ...
   public void setupGhostRecipe(Recipe<?> p_100316_, List<Slot> pSlots) {
   ...
   protected void sendUpdateSettings() {
      if (this.minecraft.getConnection() != null) {
         ...
         this.minecraft.getConnection().m_104955_(new ServerboundRecipeBookChangeSettingsPacket(recipebooktype, flag, flag1));
      }
