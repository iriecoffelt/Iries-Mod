...
public class TelemetryEventWidget extends AbstractScrollWidget {
   ...
   static class ContentBuilder {
      ...
      private final GridLayout f_260715_;
      ...
      public ContentBuilder(int pWidth) {
         this.width = pWidth;
         this.f_260715_ = new GridLayout();
         this.f_260715_.defaultCellSetting().alignHorizontallyLeft();
         this.f_260584_ = this.f_260715_.createRowHelper(1);
         this.f_260584_.addChild(SpacerElement.width(pWidth));
         this.f_260525_ = this.f_260584_.newCellSettings().alignHorizontallyCenter().paddingHorizontal(32);
      }
      ...
      public void addLine(Font pFont, Component pMessage, int pPadding) {
         this.f_260584_.addChild((new MultiLineTextWidget(pMessage, pFont)).setMaxWidth(this.width), this.f_260584_.newCellSettings().paddingBottom(pPadding));
         this.narration.append(pMessage).append("\n");
      }

      public void addHeader(Font pFont, Component pMessage) {
         this.f_260584_.addChild((new MultiLineTextWidget(pMessage, pFont)).setMaxWidth(this.width - 64).setCentered(true), this.f_260525_);
         this.narration.append(pMessage).append("\n");
      }

      public void addSpacer(int pHeight) {
         this.f_260584_.addChild(SpacerElement.height(pHeight));
      }

      public TelemetryEventWidget.Content build() {
         this.f_260715_.arrangeElements();
         return new TelemetryEventWidget.Content(this.f_260715_, this.narration);
      }
   }
}