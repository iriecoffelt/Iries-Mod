...
public class PlayerEntry extends ContainerObjectSelectionList.Entry<PlayerEntry> {
   ...
   private static final Component f_242995_ = Component.translatable("gui.socialInteractions.tooltip.report.not_reportable");
   ...
   public PlayerEntry(Minecraft pMinecraft, SocialInteractionsScreen pSocialInteractionsScreen, UUID pId, String pPlayerName, Supplier<ResourceLocation> pSkinGetter, boolean pPlayerReportable) {
      ...
      this.f_243019_ = pPlayerReportable;
      ...
      if (flag1 && flag && !playersocialmanager.isBlocked(pId)) {
         this.reportButton = new ImageButton(0, 0, 20, 20, 0, 0, 20, f_238820_, 64, 64, (p_238875_) -> {
         ...
         this.hideButton = new ImageButton(0, 0, 20, 20, 0, 38, 20, SocialInteractionsScreen.f_100736_, 256, 256, (p_100612_) -> {
         ...
         this.showButton = new ImageButton(0, 0, 20, 20, 20, 38, 20, SocialInteractionsScreen.f_100736_, 256, 256, (p_170074_) -> {
   ...
   private Tooltip createReportButtonTooltip() {
      if (!this.f_243019_) {
         return Tooltip.create(f_242995_);
   ...
   public void render(GuiGraphics pGuiGraphics, int pIndex, int pTop, int pLeft, int pWidth, int pHeight, int pMouseX, int pMouseY, boolean pHovering, float pPartialTick) {
      ...
      if (this.hasDraftReport && this.reportButton != null) {
         pGuiGraphics.blit(AbstractWidget.f_93617_, this.reportButton.getX() + 5, this.reportButton.getY() + 1, 182.0F, 24.0F, 15, 15, 256, 256);
      }
   ...
   public void setHasRecentMessages(boolean pHasRecentMessages) {
      ...
      if (this.reportButton != null) {
         this.reportButton.active = this.reportingEnabled && this.f_243019_ && pHasRecentMessages;
         this.reportButton.setTooltip(this.createReportButtonTooltip());
      }
