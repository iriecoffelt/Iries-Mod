...
public interface ProfileKeyPairManager {
   ...
   static ProfileKeyPairManager create(UserApiService pUserApiService, User pUser, Path pGameDirectory) {
      return (ProfileKeyPairManager)(pUser.getType() == User.Type.MSA ? new AccountProfileKeyPairManager(pUserApiService, pUser.m_92548_().getId(), pGameDirectory) : EMPTY_KEY_MANAGER);
   }
