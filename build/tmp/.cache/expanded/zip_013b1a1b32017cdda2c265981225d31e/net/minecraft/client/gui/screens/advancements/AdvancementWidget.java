...
public class AdvancementWidget {
   ...
   public AdvancementWidget(AdvancementTab pTab, Minecraft pMinecraft, Advancement p_97257_, DisplayInfo pDisplay) {
      this.tab = pTab;
   ...
   private AdvancementWidget getFirstVisibleParent(Advancement p_97312_) {
      ...
      return p_97312_ != null && p_97312_.m_138320_() != null ? this.tab.getWidget(p_97312_) : null;
   }
   ...
   public void draw(GuiGraphics pGuiGraphics, int pX, int pY) {
      if (!this.display.isHidden() || this.progress != null && this.progress.isDone()) {
         ...
         pGuiGraphics.blit(f_97239_, pX + this.x + 3, pY + this.y, this.display.getFrame().m_15551_(), 128 + advancementwidgettype.m_97325_() * 26, 26, 26);
   ...
   public void drawHover(GuiGraphics pGuiGraphics, int pX, int pY, float pFade, int pWidth, int pHeight) {
      ...
      if (!this.description.isEmpty()) {
         if (flag1) {
            pGuiGraphics.m_280260_(f_97239_, i1, l + 26 - j1, this.width, j1, 10, 200, 26, 0, 52);
         } else {
            pGuiGraphics.m_280260_(f_97239_, i1, l, this.width, j1, 10, 200, 26, 0, 52);
         }
      }

      pGuiGraphics.blit(f_97239_, i1, l, 0, advancementwidgettype.m_97325_() * 26, j, 26);
      pGuiGraphics.blit(f_97239_, i1 + j, l, 200 - k, advancementwidgettype1.m_97325_() * 26, k, 26);
      pGuiGraphics.blit(f_97239_, pX + this.x + 3, pY + this.y, this.display.getFrame().m_15551_(), 128 + advancementwidgettype2.m_97325_() * 26, 26, 26);
      if (flag) {
   ...
   public void attachToParent() {
      if (this.parent == null && this.f_97242_.m_138319_() != null) {
         this.parent = this.getFirstVisibleParent(this.f_97242_);
         if (this.parent != null) {
