...
public class SpectatorMenu {
   ...
   static class CloseSpectatorItem implements SpectatorMenuItem {
      ...
      public void renderIcon(GuiGraphics pGuiGraphics, float pShadeColor, int pAlpha) {
         pGuiGraphics.blit(SpectatorGui.f_94760_, 0, 0, 128.0F, 0.0F, 16, 16, 256, 256);
      }
   ...
   static class ScrollMenuItem implements SpectatorMenuItem {
      ...
      public void renderIcon(GuiGraphics pGuiGraphics, float pShadeColor, int pAlpha) {
         if (this.direction < 0) {
            pGuiGraphics.blit(SpectatorGui.f_94760_, 0, 0, 144.0F, 0.0F, 16, 16, 256, 256);
         } else {
            pGuiGraphics.blit(SpectatorGui.f_94760_, 0, 0, 160.0F, 0.0F, 16, 16, 256, 256);
         }
