...
public class SpriteLoader {
   ...
   public static CompletableFuture<List<SpriteContents>> runSpriteSuppliers(List<Supplier<SpriteContents>> p_261516_, Executor pExecutor) {
   ...
   public CompletableFuture<SpriteLoader.Preparations> loadAndStitch(ResourceManager pResouceManager, ResourceLocation pLocation, int pMipLevel, Executor pExecutor) {
      return CompletableFuture.supplyAsync(() -> {
         return SpriteResourceLoader.m_261166_(pResouceManager, pLocation).m_260886_(pResouceManager);
