...
public class RenderBuffers {
   ...
   private final SortedMap<RenderType, BufferBuilder> fixedBuffers = Util.make(new Object2ObjectLinkedOpenHashMap<>(), (p_269658_) -> {
      p_269658_.put(Sheets.solidBlockSheet(), this.fixedBufferPack.m_108839_(RenderType.solid()));
      p_269658_.put(Sheets.cutoutBlockSheet(), this.fixedBufferPack.m_108839_(RenderType.cutout()));
      p_269658_.put(Sheets.bannerSheet(), this.fixedBufferPack.m_108839_(RenderType.cutoutMipped()));
      p_269658_.put(Sheets.translucentCullBlockSheet(), this.fixedBufferPack.m_108839_(RenderType.translucent()));
