...
public class AdvancementTab {
   ...
   public AdvancementTab(Minecraft pMinecraft, AdvancementsScreen pScreen, AdvancementTabType pType, int pIndex, Advancement p_97149_, DisplayInfo pDisplay) {
      ...
      this.root = new AdvancementWidget(this, pMinecraft, p_97149_, pDisplay);
   ...
   @Nullable
   public static AdvancementTab create(Minecraft pMinecraft, AdvancementsScreen pScreen, int pIndex, Advancement p_97174_) {
      if (p_97174_.m_138320_() == null) {
         return null;
      } else {
         for(AdvancementTabType advancementtabtype : AdvancementTabType.values()) {
            if ((pIndex % AdvancementTabType.MAX_TABS) < advancementtabtype.getMax()) {
               return new AdvancementTab(pMinecraft, pScreen, advancementtabtype, pIndex % AdvancementTabType.MAX_TABS, pIndex / AdvancementTabType.MAX_TABS, p_97174_, p_97174_.m_138320_());
            }
   ...
   public void addAdvancement(Advancement p_97179_) {
      if (p_97179_.m_138320_() != null) {
         AdvancementWidget advancementwidget = new AdvancementWidget(this, this.minecraft, p_97179_, p_97179_.m_138320_());
         this.addWidget(advancementwidget, p_97179_);
      }
   }

   private void addWidget(AdvancementWidget pWidget, Advancement p_97177_) {
      this.widgets.put(p_97177_, pWidget);
      int i = pWidget.getX();
      int j = i + 28;
      int k = pWidget.getY();
      int l = k + 27;
