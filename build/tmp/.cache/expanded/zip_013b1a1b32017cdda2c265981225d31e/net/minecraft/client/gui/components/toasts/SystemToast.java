...
public class SystemToast implements Toast {
   ...
   public Toast.Visibility render(GuiGraphics pGuiGraphics, ToastComponent pToastComponent, long pTimeSinceLastVisible) {
      ...
      if (i == 160 && this.messageLines.size() <= 1) {
         pGuiGraphics.blit(f_94893_, 0, 0, 0, 64, i, this.height());
      } else {
         int j = this.height();
         int k = 28;
   ...
   private void renderBackgroundRow(GuiGraphics pGuiGraphics, ToastComponent p_281283_, int pWidth, int p_282371_, int p_283613_, int p_282880_) {
      int i = p_282371_ == 0 ? 20 : 5;
      int j = Math.min(60, pWidth - i);
      pGuiGraphics.blit(f_94893_, 0, p_283613_, 0, 64 + p_282371_, i, p_282880_);

      for(int k = i; k < pWidth - j; k += 64) {
         pGuiGraphics.blit(f_94893_, k, p_283613_, 32, 64 + p_282371_, Math.min(64, pWidth - k - j), p_282880_);
      }

      pGuiGraphics.blit(f_94893_, pWidth - j, p_283613_, 160 - j, 64 + p_282371_, j, p_282880_);
   }
