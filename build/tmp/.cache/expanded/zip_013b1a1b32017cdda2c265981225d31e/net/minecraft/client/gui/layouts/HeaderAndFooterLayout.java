...
public class HeaderAndFooterLayout implements Layout {
   ...
   private static final int f_276136_ = 30;
   ...
   public <T extends LayoutElement> T addToHeader(T pChild, LayoutSettings p_270558_) {
      return this.headerFrame.addChild(pChild, p_270558_);
   }
   ...
   public <T extends LayoutElement> T addToFooter(T pChild, LayoutSettings p_270492_) {
      return this.footerFrame.addChild(pChild, p_270492_);
   }
   ...
   public <T extends LayoutElement> T addToContents(T pChild, LayoutSettings p_270075_) {
      return this.contentsFrame.addChild(pChild, p_270075_);
   }

   public LayoutSettings m_269068_() {
      return this.headerFrame.newChildLayoutSettings();
   }

   public LayoutSettings m_269403_() {
      return this.contentsFrame.newChildLayoutSettings();
   }

   public LayoutSettings m_269493_() {
