...
public class BeaconScreen extends AbstractContainerScreen<BeaconMenu> {
   ...
   class BeaconConfirmButton extends BeaconScreen.BeaconSpriteScreenButton {
      ...
      public void onPress() {
         BeaconScreen.this.minecraft.getConnection().m_104955_(new ServerboundSetBeaconPacket(Optional.ofNullable(BeaconScreen.this.primary), Optional.ofNullable(BeaconScreen.this.secondary)));
         BeaconScreen.this.minecraft.player.closeContainer();
      }
   ...
   abstract static class BeaconSpriteScreenButton extends BeaconScreen.BeaconScreenButton {
      ...
      protected BeaconSpriteScreenButton(int pX, int pY, int p_169665_, int p_169666_, Component pMessage) {
      ...
      protected void renderIcon(GuiGraphics pGuiGraphics) {
         pGuiGraphics.blit(BeaconScreen.BEACON_LOCATION, this.getX() + 2, this.getY() + 2, this.f_98033_, this.f_98034_, 18, 18);
      }
   }
