...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
   ...
   private Component authenticateServer(String pServerHash) {
      try {
         this.getMinecraftSessionService().joinServer(this.minecraft.getUser().m_92548_(), this.minecraft.getUser().getAccessToken(), pServerHash);
         return null;
   ...
   public void handleGameProfile(ClientboundGameProfilePacket pPacket) {
      ...
      this.f_104523_ = pPacket.getGameProfile();
      this.connection.m_129498_(ConnectionProtocol.PLAY);
      net.minecraftforge.network.NetworkHooks.handleClientLoginSuccess(this.connection);
      this.connection.setListener(new ClientPacketListener(this.minecraft, this.parent, this.connection, this.serverData, this.f_104523_, this.minecraft.getTelemetryManager().createWorldSessionManager(this.newWorld, this.worldLoadDuration, this.minigameName)));
   }
   ...
   public void handleCustomQuery(ClientboundCustomQueryPacket pPacket) {
      ...
      this.connection.send(new ServerboundCustomQueryPacket(pPacket.m_134755_(), (FriendlyByteBuf)null));
   }
