...
public class CommandBlockEditScreen extends AbstractCommandBlockEditScreen {
   ...
   protected void populateAndSendPacket(BaseCommandBlock pCommandBlock) {
      this.minecraft.getConnection().m_104955_(new ServerboundSetCommandBlockPacket(BlockPos.containing(pCommandBlock.getPosition()), this.commandEdit.getValue(), this.mode, pCommandBlock.isTrackOutput(), this.conditional, this.autoexec));
   }
}