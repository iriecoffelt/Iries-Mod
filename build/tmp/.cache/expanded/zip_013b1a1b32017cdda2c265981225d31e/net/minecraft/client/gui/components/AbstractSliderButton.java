...
public abstract class AbstractSliderButton extends AbstractWidget {
   public static final ResourceLocation f_263683_ = new ResourceLocation("textures/gui/slider.png");
   protected static final int f_273913_ = 200;
   protected static final int f_273852_ = 20;
   protected static final int f_275758_ = 20;
   protected static final int f_275750_ = 4;
   protected static final int TEXT_MARGIN = 2;
   private static final int f_263696_ = 20;
   private static final int HANDLE_HALF_WIDTH = 4;
   private static final int HANDLE_WIDTH = 8;
   private static final int f_263817_ = 0;
   private static final int f_263751_ = 1;
   private static final int f_263731_ = 2;
   private static final int f_263690_ = 3;
   ...
   protected int m_264355_() {
      int i = this.isFocused() && !this.canChangeValue ? 1 : 0;
      return i * 20;
   }

   protected int m_264270_() {
   ...
   public void renderWidget(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
      ...
      pGuiGraphics.m_280027_(f_263683_, this.getX(), this.getY(), this.getWidth(), this.getHeight(), 20, 4, 200, 20, 0, this.m_264355_());
      pGuiGraphics.m_280027_(f_263683_, this.getX() + (int)(this.value * (double)(this.width - 8)), this.getY(), 8, 20, 20, 4, 200, 20, 0, this.m_264270_());
