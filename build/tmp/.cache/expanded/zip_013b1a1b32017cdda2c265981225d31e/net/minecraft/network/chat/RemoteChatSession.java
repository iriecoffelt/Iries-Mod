...
public record RemoteChatSession(UUID sessionId, ProfilePublicKey profilePublicKey) {
   ...
   public static record Data(UUID sessionId, ProfilePublicKey.Data profilePublicKey) {
      ...
      public RemoteChatSession validate(GameProfile pProfile, SignatureValidator pSignatureValidator, Duration p_251179_) throws ProfilePublicKey.ValidationException {
         return new RemoteChatSession(this.sessionId, ProfilePublicKey.createValidated(pSignatureValidator, pProfile.getId(), this.profilePublicKey, p_251179_));
      }
   }
}