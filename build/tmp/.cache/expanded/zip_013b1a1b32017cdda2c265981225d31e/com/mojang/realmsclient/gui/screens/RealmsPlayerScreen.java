...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   static final ResourceLocation f_89074_ = new ResourceLocation("realms", "textures/gui/realms/op_icon.png");
   static final ResourceLocation f_89075_ = new ResourceLocation("realms", "textures/gui/realms/user_icon.png");
   static final ResourceLocation f_89076_ = new ResourceLocation("realms", "textures/gui/realms/cross_player_icon.png");
   ...
   class Entry extends ObjectSelectionList.Entry<RealmsPlayerScreen.Entry> {
      ...
      public Entry(PlayerInfo pPlayerInfo) {
         ...
         this.removeButton = new ImageButton(j, k, 8, 7, 0, 0, 7, RealmsPlayerScreen.f_89076_, 8, 14, (p_279099_) -> {
         ...
         j += 11;
         this.makeOpButton = new ImageButton(j, k, 8, 7, 0, 0, 7, RealmsPlayerScreen.f_89075_, 8, 14, (p_279435_) -> {
         ...
         this.removeOpButton = new ImageButton(j, k, 8, 7, 0, 0, 7, RealmsPlayerScreen.f_89074_, 8, 14, (p_279383_) -> {
   ...
   class InvitedObjectSelectionList extends RealmsObjectSelectionList<RealmsPlayerScreen.Entry> {
      ...
      public void m_7733_(GuiGraphics p_282559_) {
