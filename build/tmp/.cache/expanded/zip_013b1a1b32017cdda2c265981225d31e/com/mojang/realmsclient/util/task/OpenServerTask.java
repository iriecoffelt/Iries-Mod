...
public class OpenServerTask extends LongRunningTask {
   ...
   public OpenServerTask(RealmsServer pServerData, Screen pReturnScreen, RealmsMainScreen p_181346_, boolean pJoin, Minecraft pMinecraft) {
         ...
         try {
            ...
            if (flag) {
               this.minecraft.execute(() -> {
                  ...
                  if (this.join) {
                     this.f_90416_.play(this.serverData, this.returnScreen);
                  } else {
