...
public enum ModArmorMaterials implements ArmorMaterial {
    SAPPHIRE("sapphire",26,new int[]{50,100,80,15}, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 50f, 100f, () -> Ingredient.of(ModItems.SAPPHIRE.get()));
    ...
    public String getName() {
        return IriesMod.MOD_ID + ":" + this.name;
    }
