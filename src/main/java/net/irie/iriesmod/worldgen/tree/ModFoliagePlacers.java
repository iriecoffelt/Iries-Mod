package net.irie.iriesmod.worldgen.tree;

import net.irie.iriesmod.IriesMod;
import net.irie.iriesmod.worldgen.tree.custom.PineFoliagePlacer;
...
public class ModFoliagePlacers {
    public static final DeferredRegister<FoliagePlacerType<?>> FOLIAGE_PLACERS =
            DeferredRegister.create(Registries.FOLIAGE_PLACER_TYPE, IriesMod.MOD_ID);
