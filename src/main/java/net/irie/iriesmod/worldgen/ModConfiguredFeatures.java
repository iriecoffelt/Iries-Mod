package net.irie.iriesmod.worldgen;
...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?,?>> context) {
        ...
        register(context, NETHER_SAPPHIRE_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
                ModBlocks.NETHER_SAPPHIRE_ORE.get().defaultBlockState(),8));
        register(context, END_SAPPHIRE_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
                ModBlocks.END_STONE_SAPPHIRE_ORE.get().defaultBlockState(),12));
    }


    public static ResourceKey<ConfiguredFeature<?,?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, new ResourceLocation(IriesMod.MOD_ID, name));
    }
