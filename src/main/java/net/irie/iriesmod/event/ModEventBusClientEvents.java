...
import net.irie.iriesmod.entity.client.ModModelLayers;
import net.irie.iriesmod.entity.client.RhinoModel;
...
@Mod.EventBusSubscriber(modid = IriesMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
