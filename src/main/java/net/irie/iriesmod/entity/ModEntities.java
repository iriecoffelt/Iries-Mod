package net.irie.iriesmod.entity;

import net.irie.iriesmod.IriesMod;
import net.irie.iriesmod.entity.custom.DiceProjectileEntity;
...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, IriesMod.MOD_ID);
